...
\sidenote{\footnotesize This function may be extended take other types other
than plain Julia array for more complex case.}.
%
...
\sidenote{ \footnotesize We will also see some quirks related to this design choice later,
