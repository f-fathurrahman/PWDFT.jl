...
function test_Ge_fcc()
    atoms = init_atoms_xyz_string(
        ...
        Si  0.25  0.25  0.25
        """, in_bohr=true)
    atoms.LatVecs = gen_lattice_fcc(5.658*ANG2BOHR)
    atoms.positions = atoms.LatVecs*atoms.positions
    # Initialize Hamiltonian
    #pspfiles = ["../pseudopotentials/pade_gth/Ge-q4.gth"]
    ...
    dump_bandstructure( evals, kpoints.k, kpt_spec, kpt_spec_labels, filename="TEMP_Ge_fcc_PBE.dat" )
