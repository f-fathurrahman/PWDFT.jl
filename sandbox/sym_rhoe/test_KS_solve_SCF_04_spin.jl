...
function init_Ham_atom_H()
    ...
    ecutwfc = 15.0
    return Hamiltonian( atoms, pspfiles, ecutwfc, Nspin=2, extra_states=4 )
end
...
function main()
    ...
    @time KS_solve_SCF_04!( Ham, mix_method="rpulay", startingrhoe=:random, use_smearing=true )
    #@time KS_solve_SCF_04!( Ham, mix_method="anderson", startingrhoe=:random )
