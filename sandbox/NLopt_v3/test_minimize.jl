...
function main()
    ...
    #@time KS_solve_Emin_PCG!( Ham, psiks )
    ...
    #@time KS_solve_Emin_PCG_dot!( Ham, psiks, etot_conv_thr=1e-6 )
    #KS_solve_Emin_PCG_dot!( Ham, psiks, etot_conv_thr=1e-6, skip_initial_diag=true )
    #KS_solve_Emin_PCG_dot!( Ham, psiks, etot_conv_thr=1e-6, skip_initial_diag=true )
end
